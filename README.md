...
[![Live Demo](https://img.shields.io/badge/Live_Demo-online-FCF300?logo=pwa&logoColor=black)](https://wrapity.pages.dev)
[![Angular](https://img.shields.io/badge/Angular-21-DD0031?logo=angular&logoColor=white)](https://angular.dev)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.9-3178C6?logo=typescript&logoColor=white)](https://www.typescriptlang.org)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)

<picture>
  <img src="docs/demo.gif" alt="Wrapity demo" width="320">
</picture>
...
**Dig into any album or artist.** Cover art, tracklist, and the community's rating breakdown on every album — and for artists, their full discography with per-album averages.

**See what your circle is up to.** An activity feed of every review, like, and follow from the people you follow.

**Find anything, no account needed.** Search albums, artists, and people, and like reviews from anyone. Album, artist, and profile pages are all public — the wall only goes up when you want to leave your own mark.

**Take it with you.** Installable as a PWA: add it to your home screen and it runs fullscreen, like a native app.

## Quick Start

Requires Node.js 22+ and the [backend](https://github.com/nicolasgarea/wrapity-api) running at `localhost:8000`.
